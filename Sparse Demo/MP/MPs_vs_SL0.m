...
% CoSaMP
tic;x1=myMP(y,D,s);t1=toc;
% SP
tic;x2=myOMP(y,D,s);t2=toc;
% SL0
...
subplot(311);stem(xo,'r','filled');hold on;stem(x1,'b');legend('Original','Estimated');title(['MP ---- SRR: ',num2str(sc1),'--- Time: ',num2str(tim1)]);
subplot(312);stem(xo,'r','filled');hold on;stem(x2,'b');title(['OMP ---- SRR: ',num2str(sc2),'--- Time: ',num2str(tim2)]);
